...
//  static_assert(is_prime<97>);
  ...
  assert(A1.trace() == Rational(1000));

  assert(Ar.rank() == 3);

  Matrix<3, 3, Residue<19>> M = {{1, 2, 3}, {5, 6, 7}, {1, 4, 2}};
  assert(M.det() == 1);
